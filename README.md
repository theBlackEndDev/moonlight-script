...
```
wget https://raw.githubusercontent.com/theBlackEndDev/moonlight-script/master/moonlight.sh
```
```
...
```
wget https://raw.githubusercontent.com/theBlackEndDev/moonlight-script/master/moonlight.sh  --no-check
```
